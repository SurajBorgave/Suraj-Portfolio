...
const Navbar = () => (
  <nav className="navbar glass-card" style={{ 
    ...
    <div className="logo serif" style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'var(--primary-gold)' }}>SURAJ</div>
...
const App = () => {
  ...
  return (
    <div className="portfolio-app">
      ...
      <section className="hero" style={{ height: '100vh', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <motion.div 
          ...
          style={{ 
            ...
            borderRadius: '50%', background: 'radial-gradient(circle, var(--primary-gold-glow) 0%, transparent 70%)',
      ...
      <section id="about" className="about">
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
            ...
            <div>
              <h2 className="section-title gold-text" style={{ textAlign: 'left', fontSize: '3rem' }}>The Visionary</h2>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div className="glass-card" style={{ padding: '20px' }}>
                  <h3 style={{ color: 'var(--primary-gold)' }}>50+</h3>
                  <p>Projects Delivered</p>
                </div>
                <div className="glass-card" style={{ padding: '20px' }}>
                  <h3 style={{ color: 'var(--primary-gold)' }}>12+</h3>
      ...
      <section id="projects">
        <div className="container">
          <h2 className="section-title gold-text">Featured Works</h2>
      ...
      <section id="certs">
        <div className="container">
          <h2 className="section-title gold-text">Royal Credentials</h2>
            ...
            {CERTIFICATES.map(cert => (
              ...
              >
                <div style={{ position: 'absolute', top: '-10px', right: '-10px', opacity: 0.1 }}>
                  <Award size={100} color="var(--primary-gold)" />
                </div>
                <h3 className="serif" style={{ fontSize: '1.4rem', marginBottom: '10px' }}>{cert.name}</h3>
                <p style={{ color: 'var(--primary-gold)', fontWeight: 'bold' }}>{cert.issuer}</p>
      ...
      <section>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px' }}>
            <div>
              <h2 className="section-title gold-text" style={{ textAlign: 'left', fontSize: '2.5rem' }}>Experience</h2>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                {EXPERIENCE.map(exp => (
                  <div key={exp.id} className="glass-card" style={{ padding: '30px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                      <h3 className="serif">{exp.role}</h3>
                      <span style={{ color: 'var(--primary-gold)', fontWeight: 'bold' }}>{exp.duration}</span>
                    </div>
            ...
            <div>
              <h2 className="section-title gold-text" style={{ textAlign: 'left', fontSize: '2.5rem' }}>Education</h2>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                {EDUCATION.map(edu => (
                  <div key={edu.id} className="glass-card" style={{ padding: '30px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                      <h3 className="serif">{edu.degree}</h3>
                      <span style={{ color: 'var(--primary-gold)', fontWeight: 'bold' }}>{edu.year}</span>
                    </div>
      ...
      <section>
        <div className="container" style={{ textAlign: 'center' }}>
          <h2 className="section-title gold-text">Technical Prowess</h2>
      ...
      {/* CONTACT SECTION */}
      <section id="contact" style={{ background: 'linear-gradient(to bottom, transparent, var(--bg-card))' }}>
        <div className="container">
          <div className="glass-card" style={{ padding: '80px', textAlign: 'center' }}>
            <h2 className="section-title gold-text">Begin a Legacy</h2>
            <p style={{ fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto 40px', color: 'var(--text-muted)' }}>
              Available for high-end collaborations and visionary projects. Let's create something timeless.
            </p>
            <form style={{ maxWidth: '600px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <button className="premium" type="button" style={{ padding: '15px' }}>Send Envoys</button>
            </form>
          </div>
        </div>
      </section>
      ...
      {/* FOOTER */}
      <footer style={{ padding: '50px 0', textAlign: 'center', borderTop: '1px solid var(--glass-border)' }}>
        <div className="container">
          <div className="serif" style={{ fontSize: '2rem', color: 'var(--primary-gold)', marginBottom: '20px' }}>SURAJ</div>
